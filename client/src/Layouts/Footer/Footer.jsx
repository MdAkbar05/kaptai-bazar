  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-white text-2xl font-bold mb-4">Kaptai Bazar</h2>
          <p className="text-sm leading-relaxed">
            Kaptai Bazar is your ultimate online services, offering a wide range
            of products from fresh and qualityful fish. We ensure the best
            quality and service for every customer.
          </p>
        </div>
      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} Kaptai Bazar. All rights reserved.
        </p>
