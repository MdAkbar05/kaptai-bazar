    ...
    <nav className=" shadow-lg sticky top-0 z-50">
      ...
      <div className="bg-primary">
        <div className="max-w-7xl mx-auto px-4 bg-primary">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link
                to="/"
                className="text-xl font-bold text-white flex items-center space-x-3"
              >
                <div className="overflow-hidden bg-white rounded-full h-10 w-10">
                  <img src={Logo} alt="Logo" className=" mr-2  scale-150" />
                </div>
                <span className="sm:hidden md:block ">Kaptai Bazar</span>
                <span className="sm:block md:hidden">Kaptai</span>
              </Link>
            </div>
              ...
              <div className="sm:hidden md:flex items-center">
                {profile && profile.isUser ? (
                  ...
                  <>
                    <Link
                      to="/register"
                      className="border-yellow-400 ml-4 rounded-xl px-2 py-1 text-gray-300 hover:text-secondary hover:bg-background flexCenter gap-2"
                    >
                ...
                <Link
                  ...
                  className="relative ml-4 text-background hover:text-secondary"
                >
                  <MdOutlineShoppingCart color="#E1D7B7" className="text-xl" />
                ...
                <Link
                  ...
                  className="relative ml-4 text-background hover:text-secondary"
                >
                  <MdFavoriteBorder color="#E1D7B7" className="text-xl" />
                  <span className="absolute top-[-8px] left-3 inline-flex items-center justify-center px-1 py-0.5 text-xs font-bold leading-none text-black bg-white rounded-full">
                    {totalFavCount}
                  </span>
                </Link>
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto text-hightlight bg-secondary px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
