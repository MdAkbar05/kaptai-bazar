  ...
  return (
    <div className="bg-white h-full relative py-4">
      <div className="flex justify-between items-center px-4">
        ...
        <Link
          to={`/products`}
          className="sm:text-lg md:text-xl font-medium text-gray-600 cursor-pointer text-center bg-slate-50 border border-gray-200 px-1 py-0.5 rounded-lg"
        >
          See all
        </Link>
      </div>
        ...
        {categories.map((data, index) => (
          ...
          >
            ...
            <Link
              ...
              className="text-center flexCenter border text-lg text-white font-medium px-3 py-1.5 bg-secondary rounded-2xl "
            >
              {data.title}
            </Link>
          </div>
